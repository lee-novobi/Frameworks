      ...
      <table width="100%" cellspacing="0" cellpadding="0" class="list-zebra" id="tblAlert" border="0">
        <thead>
          <tr class="table-title">
            <th colspan="7"><p class="drag">HISTORY ALERT</p></th>
          </tr>
          <tr>
        ...
        <tbody>
          <?php echo $strAlertViewHistory ?>
        </tbody>
      </table>
      <div id="div-pagination-history" style="background:#efefef; border: 1px solid #CCCCCC;"></div>
