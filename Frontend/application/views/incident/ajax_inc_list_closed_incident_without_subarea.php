<table width="100%" cellpadding="0" cellspacing="0" class="list-zebra">
    ...
    <tbody>
        ...
        <tr class="<?php echo (($row_alternate=!$row_alternate)? 'odd' : 'even') ?>">
        	...
        	<td class="t-center  <?php if (in_array($oInc['itsm_incident_id'], $arrUpdateFailInc)) { ?>bg-pink<?php } ?>"> <a href="<?php echo $base_url.'incident/incident/incident_detail?incidentid='.$oInc['itsm_incident_id'];?>">
