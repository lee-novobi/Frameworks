                ...
                <table cellpadding="2" cellspacing="3" border="0" width="100%" style="margin-bottom: 5px;">
                    <tr><td colspan="6">
                        <form id="frmFilter" action="" method="post">
                            ...
                            <input type="hidden" id="hidChangeId" value="<?php echo $strChangeId; ?>" name="change_id">
                        </form></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    ...
    function send_message(userid) {
        var url = base_url + 'contact/contact/load_popup_sms?userid=' + userid + '&change_id=' + change_id;
        CreateFancyBox('a#send_sms_' + userid, url, '70%');
    }

    function list_mobile_user(userid) {
        var url = base_url + 'contact/contact/load_popup_list_mobile_user?userid=' + userid + '&change_id=' + change_id;
        CreateFancyBox('a#list_mobile_user_' + userid, url, '70%', 380);
    }

    function get_contact_searched_by_user_domain(userDomain, incident_id) {
        var url = base_url + 'contact/contact/load_popup_user_information?user=' + userDomain + '&change_id=' + change_id;
    ...
    $(document).ready(function() {
        ...
        $('#btnSearchByUser').click(function() {
            ...
            if($.trim(keysearch_user).length == 0) {
                ...
                get_contact_searched_by_user_domain(keysearch_user, change_id);
            }
        ...
        $('#btnSearchByProduct').click(function(event) {
            ...
            if($.trim(product_name).length == 0) {
                ...
                var url = base_url + 'contact/contact/load_popup_contact_by_product?product_name=' + product_name + '&change_id=' + change_id;
        ...
        $('#search_by_user').bind('keypress', function(e) {
            ...
            if(e.keyCode == 13) {
                ...
                if($.trim(keysearch).length == 0) {
                    ...
                    var url = base_url + 'contact/contact/load_popup_user_information?user=' + keysearch + '&change_id=' + change_id;
        ...
        $('#search_by_product').bind('keypress', function(e) {
            if(e.keyCode == 13) {
                ...
                if($.trim(keysearch).length == 0) {
                    ...
                    var url = base_url + 'contact/contact/load_popup_contact_by_product?product_name=' + keysearch + '&change_id=' + change_id; 
