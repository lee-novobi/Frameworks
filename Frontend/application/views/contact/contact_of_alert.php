                ...
                <table cellpadding="2" cellspacing="3" border="0" width="100%" style="margin-bottom: 5px;">
                    <tr><td colspan="6">
                        <form id="frmFilter" action="" method="post">
                            ...
                            <input type="hidden" id="hidAlertId" value="<?php echo $strAlertId; ?>" name="alert_id">
                            <input type="hidden" id="hidZbxHostName" value="<?php echo htmlspecialchars($strZbxHostName, ENT_QUOTES, 'utf-8'); ?>" name="zbx_host_name">
                            <input type="hidden" id="hidAlertMsg" value="<?php echo htmlspecialchars($strAlertMsg, ENT_QUOTES, 'utf-8'); ?>" name="alert_message" />
                            <input type="hidden" id="hidTimeAlert" value="<?php echo $strTimeAlert; ?>" name="time_alert" />
                        </form></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
	...
	var alert_msg = '<?php echo $strAlertMsg; ?>';
    ...
    function send_message(userid) {
        var url = base_url + 'contact/contact/load_popup_sms?userid=' + userid + '&incident_id=<?php echo null;?>&alert_id=' + alert_id + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert;
        CreateFancyBox('a#send_sms_' + userid, url, '70%');
    }

    function list_mobile_user(userid) {
        var url = base_url + 'contact/contact/load_popup_list_mobile_user?userid=' + userid + '&incident_id=<?php echo null;?>&alert_id=' + alert_id + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert;
        CreateFancyBox('a#list_mobile_user_' + userid, url, '70%', 380);
    }

    function get_contact_searched_by_user_domain(userDomain, alertid) {
        var url = base_url + 'contact/contact/load_popup_user_information?user=' + userDomain + '&incident_id=<?php echo null;?>&alert_id=' + alertid + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert;
    ...
    $(document).ready(function() {
        ...
        $('#btnSearchByUser').click(function() {
            ...
            if($.trim(keysearch_user).length == 0) {
                ...
                get_contact_searched_by_user_domain(keysearch_user, alert_id);
            }
        ...
        $('#btnSearchByProduct').click(function(event) {
            ...
            if($.trim(product_name).length == 0) {
                ...
                var url = base_url + 'contact/contact/load_popup_contact_by_product?product_name=' + product_name + '&alert_id=' + alert_id + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert + '&call_from=1';
        ...
        $('#search_by_user').bind('keypress', function(e) {
            ...
            if(e.keyCode == 13) {
                ...
                if($.trim(keysearch).length == 0) {
                    ...
                    var url = base_url + 'contact/contact/load_popup_user_information?user=' + keysearch + '&incident_id=<?php echo null;?>&alert_id=' + alert_id + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert;
        ...
        $('#search_by_product').bind('keypress', function(e) {
            if(e.keyCode == 13) {
                ...
                if($.trim(keysearch).length == 0) {
                    ...
                    var url = base_url + 'contact/contact/load_popup_contact_by_product?product_name=' + keysearch + '&alert_id=' + alert_id + '&alert_msg=' + encodeURIComponent(alert_msg) + '&time_alert=' + time_alert + '&call_from=1';
