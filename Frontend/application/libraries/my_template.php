...
class MY_Template
{
	...
	function load_anchor_icon($arrData=array())
	{
		...
		if (!isset($arrData['display_call_num']))	$arrData['display_call_num'] = 0;
		if (!isset($arrData['from_alert'])) $arrData['from_alert'] = null;
		if (!isset($arrData['noof_call']))  $arrData['noof_call'] = 0;
		if (!isset($arrData['alert_history']))  $arrData['alert_history'] = ''; 
