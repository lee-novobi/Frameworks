...
#include "ExternalService/CSIncidentService.h"
...
int main(int argc, char* argv[])
{
	...
	if(CheckProc("CSIncidentService") != -1)
	{
	...
	printf ("Create CSIncidentService Parsing Process : %s !!\n", argv[0]);
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CCSIncidentService *pCSIncidentService = new CCSIncidentService("SyncConfig.ini");
			pCSIncidentService->GetListIncident();
			delete pCSIncidentService;
	}
