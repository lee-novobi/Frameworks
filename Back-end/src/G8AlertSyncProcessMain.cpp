...
#include "Processor/G8AlertSyncProcess.h"
...
int main(int argc, char* argv[])
{
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CG8AlertSyncProcess *pG8AlertSyncProcess = new CG8AlertSyncProcess("SyncConfig.ini");
			pG8AlertSyncProcess->ProcessSync();
			delete pG8AlertSyncProcess;
	}
