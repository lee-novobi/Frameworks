...
#include "Processor/IncidentFollowRemindProcess.h"
...
int main(int argc, char* argv[])
{
	...
	printf ("Create Alert CS Process : %s !!\n", argv[0]);
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CIncidentFollowRemindProcess *pIncidentFollowRemindProcess = new CIncidentFollowRemindProcess("SyncConfig.ini");
			pIncidentFollowRemindProcess->ProcessRemindSEReport();
			delete pIncidentFollowRemindProcess;
	}
