...
#include "Processor/WebHostCrossCheckProcess.h"
...
int main(int argc, char* argv[])
{
	...
	printf ("Create Web Host Cross-Check Process : %s !!\n", argv[0]);
	...
	if (child_id) {
		...
		CWebHostCrossCheckProcess *pWebHostCrossCheckProcess = new CWebHostCrossCheckProcess("WebItemConfig.ini");
		pWebHostCrossCheckProcess->CrossCheckProcess();
		delete pWebHostCrossCheckProcess;
	}
