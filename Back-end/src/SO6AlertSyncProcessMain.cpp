...
#include "Processor/SO6AlertSyncProcess.h"
...
int main(int argc, char* argv[])
{
	...
	printf ("Create SO6 Alert Parsing Process : %s !!\n", argv[0]);
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CSO6AlertSyncProcess *pSO6AlertSyncProcess = new CSO6AlertSyncProcess("SyncConfig.ini");
			pSO6AlertSyncProcess->ProcessSync();
			delete pSO6AlertSyncProcess;
	}
