...
#include "Processor/ZbxAlertSyncProcess.h"
...
int main(int argc, char* argv[])
{
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CZbxAlertSyncProcess *pZbxAlertSyncProcess = new CZbxAlertSyncProcess("SyncConfig.ini");
			pZbxAlertSyncProcess->ProcessSync();
			delete pZbxAlertSyncProcess;
	}
