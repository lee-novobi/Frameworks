#include "Processor/DCAlertSyncProcess.h"
...
int main(int argc, char* argv[])
{
	...
	printf ("Create DC Alert Sync Process : %s !!\n", argv[0]);
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CDCAlertSyncProcess *pDCAlertSyncProcess = new CDCAlertSyncProcess("SyncConfig.ini");
			pDCAlertSyncProcess->ProcessSync();
			delete pDCAlertSyncProcess;
	}
