...
#include "LogParser/WebInfoLogParser.h"
...
int main(int argc, char* argv[])
{
	...
	if(CheckProc("WebInfoParserProcess") != -1)
	{
	...
	printf ("Create WebInfo Parsing Process : %s !!\n", argv[0]);
		...
		while(!ListCfgFile.eof())
		{
			...
			if (child_id) {
				cout << "I'm parent of " << child_id << endl;
					...
					CWebInfoLogParser *pWebInfoParser = new CWebInfoLogParser(strLine.c_str());
					pWebInfoParser->ProcessParse();
					delete pWebInfoParser;
			}
		}
