...
#include "Processor/CSAlertSyncProcess.h"
...
int main(int argc, char* argv[])
{
	...
	if(CheckProc("CSAlertSyncProcess") != -1)
	{
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CCSAlertSyncProcess *pCSAlertSyncProcess = new CCSAlertSyncProcess("SyncConfig.ini");
			pCSAlertSyncProcess->ProcessSync();
			delete pCSAlertSyncProcess;
	}
