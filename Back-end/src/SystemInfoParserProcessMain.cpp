#include "LogParser/SystemInfoLogParser.h"
...
int main(int argc, char* argv[])
{
	...
	if(CheckProc("SystemInfoParser") != -1)
	{
	...
	if (ListCfgFile.is_open())
	{
		while(!ListCfgFile.eof())
		{
			...
			if (child_id) {
				...
				CSystemInfoLogParser *pSystemInfoParser = new CSystemInfoLogParser(strLine.c_str());
				pSystemInfoParser->ProcessParse();
				delete pSystemInfoParser;
			}
		}
