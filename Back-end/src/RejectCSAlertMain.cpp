...
#include "Processor/UpdateAlertSttProcess.h"
...
int main(int argc, char* argv[])
{
	...
	if (child_id) {
		cout << "I'm parent of " << child_id << endl;
			...
			CUpdateAlertSttProcess *pUpdateAlertSttProcess = new CUpdateAlertSttProcess("SyncConfig.ini");
			pUpdateAlertSttProcess->ProcessRejectCSAlert();
			delete pUpdateAlertSttProcess;
	}
